...
public class AttachService {
    ...
    public AttachService(Integer attachServiceId, String attachServiceName, Double attachServiceCost, Integer attachServiceUnit, String attachServiceStatus, Set<ContractDetail> contractDetails) {
