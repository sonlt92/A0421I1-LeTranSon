    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            <form action="/customer?actionUser=edit" method="post">
                <input type="text" name="idCus" value="${listCus.idCus}" style="display: none">
                <div class="form-group">
                    <label for="inputNameCus">Full name</label>
                    <input value="${listCus.nameCus}" type="text" class="form-control" id="inputNameCus" name="inputNameCus">
                </div>
                <div class="form-group">
                    <label for="inputDateOfBirth">Date of birth</label>
                    <input value="${listCus.dateOfBirth}" type="date" class="form-control" id="inputDateOfBirth" name="dateOfBirthCus">
                </div>
                <div class="form-group">
                    <label for="inputID">ID card</label>
                    <input value="${listCus.idCard}" type="text" class="form-control" id="inputID" name="idCus">
                </div>
                <div class="form-group">
                    <label for="inputPhone">Phone</label>
                    <input value="${listCus.phone}" type="text" class="form-control" id="inputPhone" name="phoneCus">
                </div>
                <div class="form-group">
                    <label for="exampleInputEmailEmployee">Email address</label>
                    <input value="${listCus.email}" type="email" class="form-control" id="exampleInputEmailEmployee" aria-describedby="emailHelpEmployee" name="emailCus">
                ...
                <div class="form-group">
                    ...
                    <input value="${listCus.address}" type="text" class="form-control" id="inputAddressCus" name="inputAddressCus">
                </div>
                <div class="form-group">
                    <label for="inputTypeOfCus">Type of customer</label>
                    <select class="form-control form-select" id="inputTypeOfCus" name="idTypeCus">
                        <option ${listCus.typeOfCus == "1" ? 'selected="selected"' : ''} value="1">Diamond</option>
                        <option ${listCus.typeOfCus == "2" ? 'selected="selected"' : ''}  value="2">Platinum</option>
                        <option ${listCus.typeOfCus == "3" ? 'selected="selected"' : ''}  value="3">Gold</option>
                        <option ${listCus.typeOfCus == "4" ? 'selected="selected"' : ''}  value="4">Silver</option>
                        <option ${listCus.typeOfCus == "5" ? 'selected="selected"' : ''}  value="5">Member</option>
                    </select>
                </div>
                <button type="submit" class="btn btn-primary">Submit</button>
            </form>
